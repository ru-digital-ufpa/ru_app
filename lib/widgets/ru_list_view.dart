              ...
              return Column(
                children: [
                  ...
                  RuCard(
                    ...
                    refeicaoJantar: Provider.of<Data>(context)
                        .cardapioDeHoje[index]['jantar']['refeicao'],
                    nomeDaRefiJantar: Provider.of<Data>(context)
                    ...
                    comidaJantar1: Provider.of<Data>(context)
                        .cardapioDeHoje[index]['jantar']['ingredintes']['jan1'],
                    comidaJantar2: Provider.of<Data>(context)
                        .cardapioDeHoje[index]['jantar']['ingredintes']['jan2'],
                    comidaJantar3: Provider.of<Data>(context)
                        .cardapioDeHoje[index]['jantar']['ingredintes']['jan3'],
                    comidaJantar4: Provider.of<Data>(context)
                        .cardapioDeHoje[index]['jantar']['ingredintes']['jan4'],
                    comidaJantar5: Provider.of<Data>(context)
